...
class EnableGapelessGuarantee implements KafkaConfigurationInterface, ConsumerConfigurationInterface, ProducerConfigurationInterface
{
    use BooleanConfigurationTrait;

    public const NAME = 'enable_gapless_guarantee';
    ...
    {
        return 'enable.gapless.guarantee';
    }
